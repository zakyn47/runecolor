DIARIES = {
    "Ardougne": {
        "Easy": [
            {
                "task": "Have Wizard Comperty teleport you to the Rune Essence mine.",
                "requirements": {"quests": ["Rune Mysteries"]},
            },
            {
                "task": "Steal a cake from the Ardougne market stalls.",
                "requirements": {"skills": {"Thieving": 5}},
            },
            {"task": "Sell Silk to Silk trader in Ardougne for 60 coins each."},
            ...
            {"task": "Go out fishing on the Fishing Trawler."},
            {
                ...
                "requirements": {"quests": ["Biohazard"]},
            },
            {"task": "Have Tindel Marchant identify a Rusted Sword for you."},
            {"task": "Use the Ardougne Lever to teleport to the Wilderness."},
            {"task": "View Aleck's Hunter Emporium in Yanille."},
            {"task": "Check what pets you have Insured with Probita in Ardougne."},
        ],
        "Medium": [
            {
                "task": "Enter the Unicorn pen in Ardougne zoo using Fairy rings.",
                "requirements": {"quests": ["Fairytale II - Cure a Queen"]},
            },
            {
                "task": "Grapple over Yanille's south wall.",
                "requirements": {
                    "skills": {"Agility": 39, "Strength": 38, "Ranged": 21}
                },
            },
            {
                "task": "Harvest some strawberries from the Ardougne farming patch.",
                "requirements": {"skills": {"Farming": 31}},
            },
            {
                "task": "Cast the Ardougne Teleport spell.",
                "requirements": {"quests": ["Plague City"], "skills": {"Magic": 51}},
            },
            {
                "task": "Travel to Castlewars by Hot Air Balloon.",
                "requirements": {
            ...
            },
            {
                ...
                "requirements": {"quests": ["Sea Slug"]},
            },
            {
                "task": "Pickpocket the master farmer north of Ardougne.",
                "requirements": {"skills": {"Thieving": 38}},
            },
            {
                "task": "Collect some Nightshade from the Skavid Caves.",
                "requirements": {"quests": ["Watchtower"]},
            },
            {
                "task": "Kill a swordchick in the Tower of Life.",
                "requirements": {"quests": ["Tower of Life"]},
            },
            {
                "task": "Equip Iban's upgraded staff or upgrade an Iban staff.",
                "requirements": {
        ...
        "Elite": [
            {
                "task": (
                    "Catch a Manta ray in the Fishing Trawler and cook it in Port"
                    " Khazard."
                ),
                "requirements": {"skills": {"Fishing": 81, "Cooking": 91}},
            },
            {
                "task": (
                    "Attempt to picklock the door to the basement of Yanille Agility"
                    " Dungeon."
                ),
                "requirements": {"skills": {"Thieving": 82}},
            },
            {
                "task": "Pickpocket a Hero.",
                "requirements": {"skills": {"Thieving": 80}},
            },
            {
                "task": (
                    "Make a rune crossbow yourself from scratch within Witchhaven or"
                    " Yanille."
                ),
                "requirements": {
                    "skills": {"Crafting": 10, "Smithing": 91, "Fletching": 69}
                },
            },
            {
                "task": (
                    "Imbue a salve amulet at Nightmare Zone or equip an imbued salve"
                    " amulet."
                ),
                "requirements": {"quests": ["Haunted Mine"]},
            },
            {
                "task": "Pick some Torstol from the patch north of Ardougne.",
                "requirements": {"skills": {"Farming": 85}},
            },
            {
                "task": "Complete a lap of Ardougne's rooftop agility course.",
                "requirements": {"skills": {"Agility": 90}},
            },
            {
        ...
        "Easy": [
            {
                ...
                "requirements": {"skills": {"Hunter": 5}},
            },
            {
                "task": "Mine 5 clay in the north-eastern desert.",
                "requirements": {"skills": {"Mining": 5}},
            },
        ...
        "Medium": [
            {
                ...
                "requirements": {"skills": {"Agility": 30}},
            },
            {
                "task": "Slay a desert lizard.",
                "requirements": {"skills": {"Slayer": 22}},
            },
            {
                "task": "Catch an Orange Salamander.",
                "requirements": {"skills": {"Hunter": 47}},
            },
            {
                "task": "Steal a feather from the Desert Phoenix.",
                "requirements": {"skills": {"Thieving": 25}},
            },
            {
                "task": "Travel to Uzer via Magic Carpet.",
                "requirements": {"quests": ["The Golem"]},
            },
            {
                "task": "Travel to the Desert via Eagle.",
                "requirements": {"quests": ["Eagles' Peak"]},
            },
            {
                "task": "Pray at the Elidinis statuette in Nardah.",
                "requirements": {"quests": ["Spirits of the Elid"]},
            },
            {
                "task": "Create a combat potion in the desert.",
                "requirements": {"skills": {"Herblore": 36}},
            },
            {
                "task": "Teleport to Enakhra's Temple with the Camulet.",
                "requirements": {"quests": ["Enakhra's Lament"]},
            },
            {
            ...
            {"task": "Enter your player owned house from Pollnivneach."},
            {
                ...
                "requirements": {"skills": {"Woodcutting": 35}},
            },
        ],
        "Hard": [
            {
                "task": "Knock out and pickpocket a Menaphite Thug.",
                "requirements": {"quests": ["The Feud"], "skills": {"Thieving": 65}},
            },
            {"task": "Mine some Granite.", "requirements": {"skills": {"Mining": 45}}},
            {
                "task": "Refill your waterskins in the Desert using Lunar Magic.",
                "requirements": {"quests": ["Dream Mentor"], "skills": {"Magic": 68}},
            },
            {"task": "Kill the Kalphite Queen."},
            {
                "task": "Complete a lap of the Pollnivneach agility course.",
                "requirements": {"skills": {"Agility": 70}},
            },
            {
                "task": (
                    "Slay a Dust Devil in the desert cave with a Slayer helmet"
                    " equipped."
                ),
                "requirements": {
                    "quests": ["Desert Treasure I"],
                    "skills": {"Slayer": 65, "Defence": 10, "Crafting": 55},
                },
            },
            {
                "task": (
                ...
                "requirements": {"quests": ["Desert Treasure I"]},
            },
            {
                "task": "Defeat a Locust Rider with Keris.",
                "requirements": {"quests": ["Contact!"], "skills": {"Attack": 50}},
            },
            {
                "task": "Burn some yew logs on the Nardah Mayor's balcony.",
                "requirements": {"skills": {"Firemaking": 60}},
            },
            {
        ...
        "Elite": [
            {
                ...
                "requirements": {"skills": {"Cooking": 85}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {
                    ...
                    "skills": {"Construction": 78},
                },
            },
            {
                "task": (
                    "Steal from the Grand Gold Chest in the final room of Pyramid"
                    " Plunder."
                ),
                "requirements": {
                    "quests": ["Icthlarin's Little Helper"],
            ...
            {
                "task": (
                    "Restore at least 85 Prayer points when praying at the Altar in"
                    " Sophanem."
                ),
                "requirements": {
                    "quests": ["Icthlarin's Little Helper"],
    ...
    "Falador": {
        "Easy": [
            {
                ...
                "requirements": {"skills": {"Construction": 16}},
            },
            {
                "task": "Climb over the western Falador wall.",
                "requirements": {"skills": {"Agility": 5}},
            },
            ...
            {
                "task": (
                    "Claim a security book from the Security Guard upstairs at Port"
                    " Sarim jail."
                )
            },
            {
        ...
        "Medium": [
            {
                ...
                "requirements": {"skills": {"Firemaking": 49}},
            },
            {
                "task": (
                    "Telegrab some Wine of Zamorak at the Chaos Temple by the"
                    " Wilderness."
                ),
                "requirements": {"skills": {"Magic": 33}},
            },
            {"task": "Unlock the crystal chest in Taverley."},
            {
                "task": "Place a Scarecrow in the Falador farming patch.",
        ...
        "Hard": [
            ...
            },
            {
                ...
                "requirements": {"quests": ["Heroes' Quest"]},
            },
            {
                "task": "Crack a wall safe within Rogues Den.",
                "requirements": {"skills": {"Thieving": 50}},
            },
            {
                "task": (
                    "Recharge your prayer in the Port Sarim church while wearing full"
                    " Proselyte."
                ),
                "requirements": {
            ...
            {"task": "Enter the Warriors' Guild."},
            {
                ...
                "requirements": {"quests": ["Grim Tales"], "skills": {"Defence": 50}},
            },
        ],
        "Elite": [
            {
                "task": "Craft 252 Air Runes simultaneously from Essence.",
                "requirements": {"skills": {"Runecraft": 88}},
            },
            {
                "task": "Purchase a White 2h Sword from Sir Vyvin.",
                "requirements": {"quests": ["Wanted!"]},
            },
            {
                "task": (
                    "Find at least 3 magic roots at once when digging up your magic"
                    " tree in Falador."
                ),
                "requirements": {"skills": {"Farming": 91, "Woodcutting": 75}},
            },
            {
                "task": (
                    "Perform a skillcape or quest cape emote at the top of Falador"
                    " Castle."
                )
            },
            {
                "task": "Jump over the strange floor in Taverley dungeon.",
                "requirements": {"skills": {"Agility": 80}},
            },
            {
                "task": "Mix a Saradomin brew in Falador east bank.",
                "requirements": {"skills": {"Herblore": 81}},
            },
        ],
    },
    "Fremennik": {
        "Easy": [
            {
                ...
                "requirements": {"skills": {"Hunter": 11}},
            },
            {
                "task": "Change your boots at Yrsa's Shoe Store.",
                "requirements": {"quests": ["The Fremennik Trials"]},
            },
            ...
            {
                "task": "Browse the Stonemasons shop.",
                "requirements": {"quests": ["The Giant Dwarf"]},
            },
            ...
            {"task": "Fill a bucket with water at the Rellekka well."},
            {
                ...
                "requirements": {"quests": ["Death Plateau", "Troll Stronghold"]},
            },
            {
                "task": "Chop and burn some oak logs in the Fremennik Province.",
                "requirements": {"skills": {"Woodcutting": 15, "Firemaking": 15}},
            },
        ],
        "Medium": [
            {
                "task": "Slay a Brine rat.",
                "requirements": {"quests": ["Olaf's Quest"], "skills": {"Slayer": 47}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {
                    "quests": ["The Fremennik Trials", "Horror from the Deep"]
                },
            },
            {
        ...
        "Hard": [
            {
                ...
                "requirements": {"quests": ["Eadgar's Ruse"], "skills": {"Magic": 61}},
            },
            {
                "task": "Catch a Sabre-toothed Kyatt.",
                "requirements": {"skills": {"Hunter": 55}},
            },
            {
                "task": "Mix a super defence potion in the Fremennik province.",
                "requirements": {"skills": {"Herblore": 66}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {"quests": ["Throne of Miscellania"]},
            },
            {
            ...
            {
                "task": (
                    "Obtain the Blast Furnace Foremans permission to use the Blast"
                    " Furnace for free."
                )
            },
        ],
        "Elite": [
            ...
            {
                "task": (
                    "Kill the generals of Armadyl, Bandos, Saradomin, and Zamorak in"
    ...
    "Kandarin": {
        "Easy": [
            {
                ...
                "requirements": {"skills": {"Fishing": 16}},
            },
            ...
            {
                "task": "Plant some Jute seeds in the patch north of McGrubor's Wood.",
                "requirements": {"skills": {"Farming": 13}},
            },
            {"task": "Have Galahad make you a cup of tea."},
            {
                "task": "Defeat one of each elemental in the workshop.",
                "requirements": {"quests": ["Elemental Workshop I"]},
            },
            ...
            {"task": "Speak to Sherlock."},
            {
                ...
                "requirements": {"skills": {"Agility": 20}},
            },
        ],
        "Medium": [
            {
            ...
            {
                "task": (
                    "Create a Super Antipoison potion from scratch in the"
                    " Seers/Catherby Area."
                ),
                "requirements": {"skills": {"Herblore": 48}},
            },
            {
            ...
            {
                "task": (
                    "Use the grapple shortcut to get from the water obelisk to Catherby"
                    " shore."
                ),
                "requirements": {
                    "skills": {"Ranged": 39, "Agility": 36, "Strength": 22}
                },
            },
            {
                "task": "Catch and cook a Bass in Catherby.",
                "requirements": {"skills": {"Cooking": 43, "Fishing": 46}},
            },
            {"task": "Teleport to Camelot.", "requirements": {"skills": {"Magic": 45}}},
            {
                "task": "String a Maple shortbow in Seers' Village bank.",
                "requirements": {"skills": {"Fletching": 50}},
            },
            {
                "task": "Pick some Limpwurt root from the farming patch in Catherby.",
                "requirements": {"skills": {"Farming": 26}},
            },
            {
                "task": "Create a Mind helmet.",
                "requirements": {"quests": ["Elemental Workshop II"]},
            },
            {
                "task": "Kill a Fire Giant inside Baxtorian Waterfall.",
                "requirements": {"quests": ["Waterfall Quest"]},
            },
            {"task": "Complete a wave of Barbarian Assault."},
            {
                "task": "Steal from the chest in Hemenster.",
                "requirements": {"skills": {"Thieving": 47}},
            },
            {
        ...
        "Hard": [
            {
                ...
                "requirements": {
                    "skills": {"Agility": 45, "Fishing": 70, "Strength": 45}
                },
            },
            {
                "task": "Complete a lap of the Seers' Village agility course.",
                "requirements": {"skills": {"Agility": 60}},
            },
            {
                "task": "Create a Yew Longbow from scratch around Seers' Village.",
                "requirements": {
                    "skills": {"Woodcutting": 60, "Fletching": 70, "Crafting": 10}
                },
            },
            {
                ...
                "requirements": {
                    ...
                    "skills": {"Defence": 70, "Prayer": 70},
                },
            },
            {"task": "Charge a Water Orb.", "requirements": {"skills": {"Magic": 56}}},
            {
                "task": "Burn some Maple logs with a bow in Seers' Village.",
                "requirements": {"skills": {"Firemaking": 65}},
            },
            {
            ...
            {"task": "Kill a Mithril dragon."},
            {
                ...
                "requirements": {"skills": {"Strength": 50, "Defence": 50}},
            },
            {
                "task": (
        ...
        "Elite": [
            {
                "task": (
                    "Read the blackboard at Barbarian Assault after reaching level 5 in"
                    " every role."
                )
            },
            {
                "task": "Pick some Dwarf weed from the herb patch at Catherby.",
                "requirements": {"skills": {"Farming": 79}},
            },
            {
                "task": (
                ...
                "requirements": {
                    "quests": ["Family Crest"],
                    "skills": {"Cooking": 80, "Fishing": 76},
                },
            },
            {
                "task": "Mix a Stamina Mix on top of the Seers' Village bank.",
                "requirements": {"skills": {"Agility": 60, "Herblore": 86}},
            },
            {
                "task": "Smith a Rune Hasta at Otto's Grotto.",
                "requirements": {"skills": {"Smithing": 90}},
            },
            {
                "task": "Construct a Pyre ship from Magic Logs.",
                "requirements": {"skills": {"Firemaking": 85, "Crafting": 85}},
            },
            {
    ...
    "Karamja": {
        "Easy": [
            ...
            {
                "task": (
                    "Use the rope swing to travel to the small island north-west of"
                    " Karamja, where the moss giants are."
                ),
                "requirements": {"skills": {"Agility": 10}},
            },
            {
                "task": (
                    "Mine some gold from the rocks on the north-west peninsula of"
                    " Karamja."
                ),
                "requirements": {"skills": {"Mining": 40}},
            },
            ...
            {"task": "Travel to Ardougne via the port near Brimhaven."},
            {
                ...
                "requirements": {"skills": {"Agility": 15}},
            },
        ...
        "Medium": [
            ...
            },
            {
                ...
                "requirements": {"quests": ["Dragon Slayer I"]},
            },
            {
            ...
            },
            {
                ...
                "requirements": {"skills": {"Cooking": 16}},
            },
            {
                "task": (
            ...
            },
            {
                ...
                "requirements": {"quests": ["Jungle Potion"], "skills": {"Mining": 40}},
            },
        ],
        "Hard": [
            ...
            },
            {
                ...
                "requirements": {
                    "skills": {"Ranged": 42, "Agility": 53, "Strength": 21}
                },
            },
            {
        ...
        "Elite": [
            {
                ...
                "requirements": {"skills": {"Runecraft": 91}},
            },
            ...
            },
            {
                ...
                "requirements": {"skills": {"Herblore": 87}},
            },
            {
                "task": "Check the health of your Calquat tree patch.",
                "requirements": {"skills": {"Farming": 72}},
            },
        ],
    },
    "Kourend & Kebos": {
        ...
        "Medium": [
            ...
            {
                "task": (
                    "Use Kharedst's memoirs to teleport to all five cities in Great"
                    " Kourend."
                ),
                "requirements": {
                    "quests": [
            ...
            },
            {
                ...
                "requirements": {"skills": {"Mining": 42}},
            },
            {
                "task": "Enter the Farming Guild.",
                "requirements": {"skills": {"Farming": 45}},
            },
            {"task": "Switch to the Arceuus spellbook via Tyss."},
            {
                "task": "Repair a Piscarilius crane.",
                "requirements": {"skills": {"Crafting": 30}},
            },
            {"task": "Deliver some intelligence to Captain Ginea."},
            {
                "task": "Catch a Bluegill on Molch Island.",
                "requirements": {"skills": {"Hunter": 35, "Fishing": 43}},
            },
            {
                "task": "Use the boulder leap in the Arceuus essence mine.",
                "requirements": {"skills": {"Agility": 49}},
            },
            {
                "task": "Subdue the Wintertodt.",
                "requirements": {"skills": {"Firemaking": 50}},
            },
            {
                "task": "Catch a Chinchompa in the Kourend Woodland.",
                "requirements": {"quests": ["Eagles' Peak"], "skills": {"Hunter": 53}},
            },
            {
                "task": "Chop some Mahogany logs north of the Farming Guild.",
                "requirements": {"skills": {"Woodcutting": 50}},
            },
        ],
        "Hard": [
            {
                "task": "Enter the Woodcutting Guild.",
                "requirements": {"skills": {"Woodcutting": 60}},
            },
            {
            ...
            {"task": "Mine some Lovakite.", "requirements": {"skills": {"Mining": 65}}},
            {
                "task": "Plant some Logavano seeds at the Tithe Farm.",
                "requirements": {"skills": {"Farming": 74}},
            },
            {"task": "Kill a zombie in the Shayzien Crypts."},
            {
                "task": "Teleport to Xeric's Heart using Xeric's Talisman.",
                "requirements": {"quests": ["Architectural Alliance"]},
            },
            {
                "task": "Deliver an artefact to Captain Khaled.",
                "requirements": {"skills": {"Thieving": 49}},
            },
            {
                "task": "Kill a Wyrm in the Karuulm Slayer Dungeon.",
                "requirements": {"skills": {"Slayer": 62}},
            },
            {
                "task": "Cast Monster Examine on a Troll south of Mount Quidamortem.",
                "requirements": {"quests": ["Dream Mentor"], "skills": {"Magic": 66}},
            },
        ],
        "Elite": [
            {
                "task": "Craft one or more Blood runes from Dark essence fragments.",
                "requirements": {
                    "skills": {"Mining": 38, "Runecraft": 77, "Crafting": 38}
                },
            },
            {
                "task": "Chop some Redwood logs.",
                "requirements": {"skills": {"Woodcutting": 90}},
            },
            {"task": "Defeat Skotizo in the Catacombs of Kourend."},
            {
                "task": "Catch an Anglerfish and cook it whilst in Great Kourend.",
                "requirements": {"skills": {"Cooking": 84, "Fishing": 82}},
            },
            {
                "task": "Kill a Hydra in the Karuulm Slayer Dungeon.",
                "requirements": {"skills": {"Slayer": 95}},
            },
            {
                "task": "Create an Ape Atoll teleport tablet.",
                "requirements": {"skills": {"Mining": 38, "Magic": 90, "Crafting": 38}},
            },
            {"task": "Complete a raid in the Chambers of Xeric."},
            {
                ...
                "requirements": {"skills": {"Fletching": 40, "Farming": 85}},
            },
        ],
    },
    "Lumbridge & Draynor": {
        "Easy": [
            ...
            },
            {
                ...
                "requirements": {"skills": {"Slayer": 7}},
            },
            {
                "task": "Have Sedridor teleport you to the Essence Mine.",
                "requirements": {"quests": ["Rune Mysteries"]},
            },
            {
            ...
            {"task": "Kill a zombie in the Draynor Sewers."},
            {
                ...
                "requirements": {"skills": {"Fishing": 15}},
            },
            {
                "task": "Bake some Bread on the Lumbridge kitchen range.",
                "requirements": {"quests": ["Cook's Assistant"]},
            },
            {
        ...
        "Medium": [
            ...
            },
            {
                ...
                "requirements": {
                    "skills": {"Ranged": 37, "Agility": 8, "Strength": 19}
                },
            },
            {
            ...
            },
            {
                ...
                "requirements": {"skills": {"Magic": 31}},
            },
            {
                "task": "Catch some Salmon in Lumbridge.",
                "requirements": {"skills": {"Fishing": 30}},
            },
            {
                "task": "Craft a coif in the Lumbridge cow pen.",
                "requirements": {"skills": {"Crafting": 38}},
            },
            {
                "task": "Chop some willow logs in Draynor Village.",
                "requirements": {"skills": {"Woodcutting": 30}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {"quests": ["Lost City"], "combat": 70},
            },
            {
                "task": "Catch an Essence or Eclectic impling in Puro-Puro.",
                "requirements": {"quests": ["Lost City"], "skills": {"Hunter": 42}},
            },
            {
        ...
        "Hard": [
            {
                ...
                "requirements": {"skills": {"Magic": 60}},
            },
            {
                "task": (
                    "Squeeze past the jutting wall on your way to the cosmic altar."
                ),
                "requirements": {"quests": ["Lost City"], "skills": {"Agility": 46}},
            },
            {
                "task": "Craft 56 Cosmic runes simultaneously from Essence.",
                "requirements": {"quests": ["Lost City"], "skills": {"Runecraft": 59}},
            },
            {
                "task": "Travel from Lumbridge to Edgeville on a Waka Canoe.",
                "requirements": {"skills": {"Woodcutting": 57}},
            },
            {
                "task": "Collect at least 100 Tears of Guthix in one visit.",
                "requirements": {"quests": ["Tears of Guthix"]},
            },
            {
                "task": "Take the train from Dorgesh-Kaan to Keldagrim.",
                "requirements": {"quests": ["Another Slice of H.A.M."]},
            },
            {
                "task": "Purchase some Barrows gloves from the Lumbridge bank chest.",
                "requirements": {"quests": ["Recipe for Disaster"]},
            },
            {
                "task": "Pick some Belladonna from the farming patch at Draynor Manor.",
                "requirements": {"skills": {"Farming": 63}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {"skills": {"Prayer": 52}},
            },
            {
                "task": "Craft, string and enchant an Amulet of Power in Lumbridge.",
                "requirements": {"skills": {"Magic": 57, "Crafting": 70}},
            },
        ],
        "Elite": [
            {
            ...
            },
            {
                ...
                "requirements": {
                    "quests": ["Death to the Dorgeshuun"],
                    "skills": {"Ranged": 70, "Agility": 70, "Strength": 70},
                },
            },
            {
                "task": "Chop some magic logs at the Mage Training Arena.",
                "requirements": {"skills": {"Woodcutting": 75}},
            },
            {
                "task": "Smith an Adamant platebody down Draynor sewer.",
                "requirements": {"skills": {"Smithing": 88}},
            },
            {
    ...
    "Morytania": {
        "Easy": [
            {
                ...
                "requirements": {"skills": {"Crafting": 15}},
            },
            {
                "task": "Cook a thin Snail on the Port Phasmatys range.",
                "requirements": {"skills": {"Cooking": 12}},
            },
            {"task": "Get a slayer task from Mazchna.", "requirements": {"combat": 20}},
            {
                "task": "Kill a Banshee in the Slayer Tower.",
                "requirements": {"skills": {"Slayer": 15}},
            },
        ...
        "Medium": [
            ...
            },
            {
                ...
                "requirements": {"quests": ["Cabin Fever"], "skills": {"Cooking": 40}},
            },
            ...
            },
            {
                ...
                "requirements": {"quests": ["Rum Deal"], "skills": {"Slayer": 42}},
            },
            {
                "task": "Use an ectophial to return to Port Phasmatys.",
                "requirements": {"quests": ["Ghosts Ahoy"]},
            },
            {
        ...
        "Hard": [
            {
                ...
                "requirements": {
                    "quests": ["Desert Treasure I"],
                    "skills": {"Construction": 50, "Magic": 66},
                },
            },
            {
                "task": "Climb the advanced spike chain within Slayer Tower.",
                "requirements": {"skills": {"Agility": 71}},
            },
            {
                "task": (
                    "Harvest some Watermelon from the Allotment patch on Harmony"
                    " Island."
                ),
                "requirements": {
            ...
            },
            {
                ...
                "requirements": {"quests": ["In Aid of the Myreque"]},
            },
            {
                "task": "Kill a Cave Horror.",
                "requirements": {"quests": ["Cabin Fever"], "skills": {"Slayer": 58}},
            },
            {
                "task": "Harvest some Bittercap Mushrooms from the patch in Canifis.",
                "requirements": {"skills": {"Farming": 53}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {"skills": {"Agility": 65}},
            },
            {
                "task": "Mine some Mithril ore in the Abandoned Mine.",
                "requirements": {"quests": ["Haunted Mine"], "skills": {"Mining": 55}},
            },
        ],
        "Elite": [
            {
    ...
    "Varrock": {
        "Easy": [
            ...
            {"task": "Enter the second level of the Stronghold of Security."},
            {
                ...
                "requirements": {"skills": {"Agility": 13}},
            },
            ...
            {
                "task": (
                    "Spin a bowl on the pottery wheel and fire it in the oven in Barb"
                    " Village."
                ),
                "requirements": {"skills": {"Crafting": 8}},
            },
            {"task": "Speak to Haig Halen after obtaining at least 50 Kudos."},
            {
                "task": "Craft some Earth runes from Essence.",
                "requirements": {"skills": {"Runecraft": 9}},
            },
            {
        ...
        "Medium": [
            ...
            },
            {
                ...
                "requirements": {"skills": {"Magic": 25}},
            },
            {"task": "Get a Slayer task from Vannaka.", "requirements": {"combat": 40}},
        ...
        "Hard": [
            {
                "task": (
                    "Trade furs with the Fancy Dress Seller for a spottier cape and"
                    " equip it."
                ),
                "requirements": {"skills": {"Hunter": 66}},
            },
            ...
            {
                "task": (
                    "Chop some yew logs in Varrock and burn them at the top of the"
                    " Varrock church."
                ),
                "requirements": {"skills": {"Woodcutting": 60, "Firemaking": 60}},
            },
            {
                "task": (
                    "Have the Varrock estate agent decorate your house with Fancy"
                    " Stone."
                ),
                "requirements": {"skills": {"Construction": 50}},
            },
            {
                "task": (
                    "Collect at least 2 yew roots from the Tree patch in Varrock"
                    " Palace."
                ),
                "requirements": {"skills": {"Woodcutting": 60, "Farming": 68}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {"skills": {"Agility": 51}},
            },
        ],
        "Elite": [
            {
            ...
            {
                "task": "Use Lunar magic to make 20 mahogany planks at the Lumberyard.",
                "requirements": {"quests": ["Dream Mentor"], "skills": {"Magic": 86}},
            },
            {
                "task": "Bake a summer pie in the Cooking Guild.",
                "requirements": {"skills": {"Cooking": 95}},
            },
            {
    ...
    "Western Provinces": {
        "Easy": [
            ...
            {"task": "Score a goal in a Gnome Ball match."},
            {
                ...
                "requirements": {"quests": ["Big Chompy Bird Hunting"]},
            },
            ...
            {
                "task": "Fletch an Oak shortbow from the Gnome Stronghold.",
                "requirements": {"skills": {"Fletching": 20}},
            },
        ...
        "Medium": [
            ...
            },
            {
                ...
                "requirements": {"combat": 70},
            },
            {
                "task": "Travel to the Feldip Hills by Gnome Glider.",
                "requirements": {"quests": ["One Small Favour", "The Grand Tree"]},
            },
            {
                "task": (
                    "Claim a Chompy bird hat from Rantz after registering at least 125"
                    " kills."
                ),
                "requirements": {"quests": ["Big Chompy Bird Hunting"]},
            },
            ...
            },
            {
                ...
                "requirements": {"skills": {"Cooking": 42}},
            },
            {
                "task": "Complete a delivery for the Gnome Restaurant.",
                "requirements": {"skills": {"Cooking": 29}},
            },
            {
                "task": "Turn your small crystal seed into a Crystal saw.",
                "requirements": {"quests": ["The Eyes of Glouphrie"]},
            },
            {
        ...
        "Hard": [
            ...
            },
            {
                ...
                "requirements": {
                    "quests": ["Swan Song"],
                    "skills": {"Cooking": 62, "Fishing": 62},
                },
            },
            {
                "task": "Complete a veteran game of Pest Control.",
                "requirements": {"combat": 100},
            },
            {
                "task": "Catch a Dashing Kebbit.",
                "requirements": {"skills": {"Hunter": 69}},
            },
            {
            ...
            },
            {
                ...
                "requirements": {"quests": ["Regicide"], "skills": {"Mining": 70}},
            },
            {
            ...
            {
                "task": (
                    "Claim a Chompy bird hat from Rantz after registering at least 300"
                    " kills."
                ),
                "requirements": {"quests": ["Big Chompy Bird Hunting"]},
            },
            ...
            {"task": "Kill Zulrah.", "requirements": {"quests": ["Regicide"]}},
            {
        ...
        "Elite": [
            ...
            },
            {
                ...
                "requirements": {"skills": {"Slayer": 93}},
            },
            {
                "task": "Have Prissy Scilla protect your Magic tree.",
                "requirements": {"skills": {"Farming": 75}},
            },
            {
            ...
            {
                "task": (
                    "Claim a Chompy bird hat from Rantz after registering at least 1000"
                    " kills."
                ),
                "requirements": {"quests": ["Big Chompy Bird Hunting"]},
            },
    ...
    "Wilderness": {
        "Easy": [
            ...
            {"task": "Kill a mammoth (south-east of the Ferox Enclave)."},
            {
            ...
            {
                "task": (
                    "Collect 5 red spider's eggs from the Wilderness (can be found in"
                    " the northern part of the Edgeville Dungeon).Players can drop and"
                    " pick up the same spider egg five times."
                )
            },
            {
            ...
            },
            {
                ...
                "requirements": {"quests": ["Enter the Abyss"]},
            },
            {
                "task": (
                    "Equip any team cape in the Wilderness (entering the Wilderness"
                    " with one already equipped does not count)."
                )
            },
        ],
        "Medium": [
            {
                ...
                "requirements": {"skills": {"Mining": 55}},
            },
            {
                "task": "Chop some yew logs from a fallen Ent.",
                "requirements": {"skills": {"Woodcutting": 61}},
            },
            {"task": "Enter the Wilderness God Wars Dungeon."},
            {
                "task": "Complete a lap of the Wilderness Agility course.",
                "requirements": {"skills": {"Agility": 52}},
            },
            {"task": "Kill a green dragon (must be within the Wilderness)."},
            {"task": "Kill an ankou in the Wilderness."},
            {"task": "Charge an Earth Orb.", "requirements": {"skills": {"Magic": 60}}},
            {
                "task": "Kill a Bloodveld in the Wilderness Godwars Dungeon.",
                "requirements": {"skills": {"Slayer": 50}},
            },
        ...
        "Hard": [
            {
                "task": (
                    "Cast one of the 3 God spells against another player in the"
                    " Wilderness."
                ),
                "requirements": {"quests": ["Mage Arena I"], "skills": {"Magic": 60}},
            },
            {"task": "Charge an Air Orb.", "requirements": {"skills": {"Magic": 66}}},
            {
                "task": "Catch a Black Salamander in the Wilderness.",
                "requirements": {"skills": {"Hunter": 67}},
            },
            {
                "task": "Smith an Adamant scimitar in the Resource Area.",
                "requirements": {"skills": {"Smithing": 75}},
            },
            ...
            },
            {
                ...
                "requirements": {"skills": {"Slayer": 68}},
            },
            {
                "task": "Fish some Raw Lava Eel in the Wilderness.",
                "requirements": {"skills": {"Fishing": 53}},
            },
        ],
        "Elite": [
